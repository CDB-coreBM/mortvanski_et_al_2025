...
#Open the JPEG device with high resolution
jpeg(filename = "genera_corrplot.jpg", width = 4000, height = 2000, res = 900)

#Generate the corrplot directly inside the device
corrplot(matrix_genera_BH, method = "circle", type = "full", col = COL2(c("RdBu")), tl.col = "black", tl.srt = 45, tl.cex = 1, p.mat = data.matrix(p_BH), insig = "blank", sig.level = 0.01)
...
#Now we filtrate the results: first the columns of interest and then according to p values 
corr_diversity <- as.matrix(corr[, c(1:3)], corr[, c(4:13)])
...
#Open the JPEG device with high resolution
jpeg(filename = "diversity_corrplot.jpg", width = 4800, height = 2000, res = 900)
